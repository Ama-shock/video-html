        ...
        <div className="controller-list">
            ...
            {controllers.length === 0 ? (
                ...
                <table className="controller-table">
                    <thead>
                        <tr><th>ID</th><th>VID</th><th>PID</th><th>Inst</th><th>状態</th><th>操作</th></tr>
                    </thead>
                    <tbody>
                        {controllers.map(c => (
                            <tr key={c.id}>
                                ...
                                <td>
                                    <button className="btn btn-danger btn-sm" onClick={() => removeController(c.id)}>
                                        削除
                                    </button>
                                </td>
                            </tr>
            ...
            {devices.length > 0 && (
                <>
                    ...
                    <table className="device-table">
                        <thead>
                            <tr><th>VID</th><th>PID</th><th>Inst</th><th>説明</th><th>ドライバ</th><th>操作</th></tr>
                        </thead>
                        <tbody>
                            {devices.map((d, i) => (
                                <tr key={i}>
