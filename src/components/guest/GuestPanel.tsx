...
import { setRoomKey, setStatus, setHostStream, setControllerAssignment, setError, reset } from '../../store/guestSlice';
import { fetchGatewayInfo, createRoomKey, validateRoomKeyFormat } from '../../webpush/gateway';
...
export default function GuestPanel() {
    ...
    const roomKey = useSelector((s: RootState) => s.guest.roomKey);
